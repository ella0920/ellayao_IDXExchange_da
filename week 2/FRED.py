...
import pandas as pd
sold = pd.read_csv('merged_sold.csv') 
listings = pd.read_csv('merged_listing.csv')
...
# Step 6 - Generate csv
sold_with_rates.to_csv('combined_sold_enriched.csv', index=False)
listings_with_rates.to_csv('combined_listings_enriched.csv', index=False)
